"""
Repositories for managing database models.
- DatabaseModelRepository: handles ML-specific logic (models, scalers, metadata)
- BaseRepository: generic CRUD repository for standard models
"""
...
class DatabaseModelRepository:
    ...
    def save_model(self, model_name: str, model: Any, model_type: str,
        ...
        """Save a trained model with metadata to the database"""
    ...
    def get_model_metadata(self, model_name: str) -> Optional[Dict]:
        ...
        with db_session() as session:
            ...
            if not ml_model:
                return None
            league = session.query(League).get(ml_model.league_id)
    ...
    def delete_model(self, model_name: str) -> bool:
        ...
        with db_session() as session:
            ...
            logger.info(f"Soft deleted model '{model_name}'")
            return True
...
# Optional Generic Base Repository
class BaseRepository:
    ...
    def get_by_id(self, obj_id):
        with db_session() as session:
            return session.get(self.model_class, obj_id)
